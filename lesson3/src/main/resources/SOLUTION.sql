...
alter table payment add constraint alter column type_id set not null;

alter table payment add constraint alter column payment_date set not null;

alter table payment add constraint alter column student_id set not null;
